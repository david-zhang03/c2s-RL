#!/bin/bash
#SBATCH --job-name=QA_large_dataset_msigdb
#SBATCH --output /home/ddz5/Desktop/c2s-RL/gene_programs_dev/logs/QA_dataset_msigdb/train_model_large_dataset/slurm_%j.log
...
DATASET_DIR="/home/ddz5/scratch/Cell2GSEA_QA_dataset_models/large_datasets/"
SLEEP_INTERVAL=3600  # Interval to check for processed datasets (in seconds)
